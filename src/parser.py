...
parser.add_argument("--mirror_img", type=bool, default=True, help="If True, mirror images, to increase information")
parser.add_argument("--test", type=bool, default=False, help="If True, test the model")
parser.add_argument("--loop", type=bool, default=False, help="If the loopback is activated discart duplicate messages")
